...
export const globalCountries: Country[] = [
  // African Countries (Complete List - All 54 Countries)
...
// Helper functions for filtering countries
export const getCountriesByContinent = (continent: string): Country[] => {
  return globalCountries.filter(country => country.continent === continent);
};
...
// Helper function to validate if a country exists
export const isValidCountry = (countryName: string): boolean => {
  return globalCountries.some(country => country.name === countryName);
};
